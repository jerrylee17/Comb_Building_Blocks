...
#
# Generated by Vivado on Mon Nov 25 14:08:37 -0800 2019
...
#
#    "C:/Users/jerry/Lab3/Lab3.srcs/sources_1/new/Encoder_if.v"
#    "C:/Users/jerry/Lab3/Lab3.srcs/sources_1/new/priority_encoder_FPGA_real.v"
#    "C:/Users/jerry/Lab3/Lab3.srcs/sources_1/new/Encoder_case.v"
#    "C:/Users/jerry/Lab3/Lab3.srcs/sources_1/new/Encoder_for.v"
#    "C:/Users/jerry/Lab3/Lab3.srcs/sim_1/new/tb_enc.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/jerry/Downloads/Nexys4DDR_Master.xdc"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/Lab3.srcs/sources_1/new/Encoder_if.v" ]\
 [file normalize "${origin_dir}/Lab3.srcs/sources_1/new/priority_encoder_FPGA_real.v" ]\
 [file normalize "${origin_dir}/Lab3.srcs/sources_1/new/Encoder_case.v" ]\
 [file normalize "${origin_dir}/Lab3.srcs/sources_1/new/Encoder_for.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "priority_encoder_FPGA_real" -objects $obj
...
set file "[file normalize "$origin_dir/../Downloads/Nexys4DDR_Master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Downloads/Nexys4DDR_Master.xdc"
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/Lab3.srcs/sim_1/new/tb_enc.v" ]\
]
...
if {[string equal [get_runs -quiet synth_2] ""]} {
    create_run -name synth_2 -part xc7a100tcsg324-1 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet synth_3] ""]} {
    create_run -name synth_3 -part xc7a200tfbg676-2 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet synth_4] ""]} {
    create_run -name synth_4 -part xc7a100tcsg324-3 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs synth_4]
  set_property flow "Vivado Synthesis 2019" [get_runs synth_4]
}
...
if {[string equal [get_runs -quiet synth_5] ""]} {
    create_run -name synth_5 -part xc7a100tcsg324-2 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs synth_5]
  set_property flow "Vivado Synthesis 2019" [get_runs synth_5]
}
...
current_run -synthesis [get_runs synth_5]
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7a100tcsg324-1 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
...
if {[string equal [get_runs -quiet impl_3] ""]} {
    create_run -name impl_3 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_3
} else {
...
if {[string equal [get_runs -quiet impl_4] ""]} {
    create_run -name impl_4 -part xc7a100tcsg324-3 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_4
} else {
...
if {[string equal [get_runs -quiet impl_5] ""]} {
    create_run -name impl_5 -part xc7a100tcsg324-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_5
} else {
