...
HD_PWD='C:/Users/jerry/Lab3/Lab3.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log enc_case.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enc_case.tcl -notrace
