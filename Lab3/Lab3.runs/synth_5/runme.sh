...
HD_PWD='C:/Users/jerry/Lab3/Lab3.runs/synth_5'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_FPGA_real.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder_FPGA_real.tcl
