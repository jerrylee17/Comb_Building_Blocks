...
HD_PWD='C:/Users/jerry/Lab3/Lab3.runs/impl_5'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_FPGA_real.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder_FPGA_real.tcl -notrace
