...
HD_PWD='C:/Users/jerry/Lab3/Lab3.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log enc_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_case.tcl
